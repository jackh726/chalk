...
struct_zip!(impl[TF: TypeFamily] Zip<TF> for Normalize<TF> { associated_ty_id, substitution, ty });
...
enum_zip!(impl<TF> for WhereClause<TF> { Implemented, ProjectionEq, Normalize });
