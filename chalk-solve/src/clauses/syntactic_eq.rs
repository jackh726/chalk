...
use chalk_ir::{
    ...
    interner::Interner,
    AliasEq, AliasTy, Binders, BoundVar, DebruijnIndex, Fallible, Goal, GoalData, Goals, ProgramClause,
    ProgramClauseData, ProgramClauseImplication, QuantifierKind, Ty, TyData, TyKind, VariableKind,
    VariableKinds,
};
...
impl<'i, I: Interner> Folder<'i, I> for SynEqFolder<'i, I> {
    ...
    fn fold_program_clause(
        ...
        let (binders, implication) = clause.data(interner).0.clone().into();
