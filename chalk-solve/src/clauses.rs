    ...
    match goal {
        ...
        DomainGoal::Holds(WhereClause::Normalize(Normalize {
            ...
            let trait_parameters =
                db.trait_parameters_from_projection(associated_ty_id, substitution);
...
fn match_ty<TF: TypeFamily>(
    ...
    match ty.data() {
        ...
        TyData::Projection(projection_ty) => builder
            ...
            .to_program_clauses(builder),
        TyData::NormalizedProjection(projection_ty) => builder
            .db
            .associated_ty_data(projection_ty.projection.associated_ty_id)
            .to_program_clauses(builder),
